...
* **agents,web:** Introduce AG-UI protocol via RelayEmitter [PR1/4] ([ee2c422](https://github.com/getyak/apply-agent/commit/ee2c4229caac6c907f936cd16c04a815300ddf9d))
...
* **web:** Add scroll-led product journey ([c9c2595](https://github.com/getyak/apply-agent/commit/c9c259585d2ac9b06ab684d0e96750711509d103))
* **web:** Add scroll-led product journey ([264e813](https://github.com/getyak/apply-agent/commit/264e8130fd233329d38af257b93cce6a734d6f7b))
* **web:** Rebuild dock rendering on AG-UI step model [PR3/4] ([139dd7a](https://github.com/getyak/apply-agent/commit/139dd7add0dd00ef69eb7cbb550b6cf1cd564a38))
* **web:** Redesign homepage around product evidence ([a4d48e2](https://github.com/getyak/apply-agent/commit/a4d48e200e17e8f64da2c298fb1f551525bb4d4a))
* **web:** Redesign homepage around product evidence ([748f5c8](https://github.com/getyak/apply-agent/commit/748f5c816ca93ffbc3a0cfb448d9c8b659e1cfc7))
* **web:** Round-12 Resume Studio audit + 错误处理 UI 体系 ([aa09532](https://github.com/getyak/apply-agent/commit/aa095328e226c9dfa59e951b9cc5af3d688064a5))
* **web:** SEO basics — landing page to 100/100 ([#25](https://github.com/getyak/apply-agent/issues/25)) ([870f825](https://github.com/getyak/apply-agent/commit/870f82528249d64f8cc1cfc5cb1c78605c009bcf))
* **web:** Showcase real product demo ([25dfad7](https://github.com/getyak/apply-agent/commit/25dfad7ab2ccc187605813bd6455882bfbdf48d5))
* **web:** Showcase real product demo ([6637228](https://github.com/getyak/apply-agent/commit/66372285635901d02ba32af0886f55a021d2b5d6))


### Bug Fixes

* **ci:** 解决 PR[#14](https://github.com/getyak/apply-agent/issues/14) 全部 CICD 失败 — secrets/agents/web lint 三处根因修复 ([e1683eb](https://github.com/getyak/apply-agent/commit/e1683eb1495636660f237da2ad60b03716c229fe))
* Harden pristine-env test fixture + landing reveal safety net ([eeb2458](https://github.com/getyak/apply-agent/commit/eeb2458d72b80d400fe3662d93fc65dca1ee056d))
...
* Resolve web lint errors — add Link import, escape single quotes in JSX ([9910630](https://github.com/getyak/apply-agent/commit/99106308930765f7906369cfe35b23ccccf97892))
...
* **web:** Force-reveal landing sections after 2.5s safety deadline ([09c5a73](https://github.com/getyak/apply-agent/commit/09c5a739b43cea156b6549a91686c5ac6d5c826d))
* **web:** Harden agui contract test against fixture upgrade [integration] ([e3cf808](https://github.com/getyak/apply-agent/commit/e3cf808689e950858100dda61f706b26400c9a28))
