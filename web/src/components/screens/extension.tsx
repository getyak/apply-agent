...
function profileFields(
  ...
  const name = parsedResume?.basics?.name || currentUser?.displayName || t("field.yourName");
  ...
  const phone = t("field.addPhone");
  return [
    { label: t("field.fullName"), value: name, placeholder: t("field.fullNamePlaceholder") },
    { label: t("field.email"), value: email, placeholder: "you@example.com" },
    { label: t("field.phone"), value: phone, placeholder: "(000) 000-0000" },
  ] as const;
}
...
export function ExtensionScreen() {
  ...
  const fields = profileFields(currentUser, parsedResume, t);
        ...
        <div className="mx-auto max-w-[620px] px-6 py-12 pb-32">
          <div className="flex items-center gap-4">
            <div
              ...
              aria-label={t("companyLogo", { company: job.co })}
            >
              {job.mono}
            </div>
          ...
          <div className="mt-10 space-y-6">
            ...
            <FormField
              label={t("whyInterested", { company: job.co })}
          ...
          <button
            ...
            aria-label={t("atsSubmitDisabled")}
          >
            {t("submitApplication")}
          </button>
        </div>
        ...
        <div className="p-4">
          {!eFilled ? (
            <div className="flex items-center gap-3 py-2" role="status" aria-live="polite">
              ...
              <span className="text-[14px] text-ink-light">{t("filling")}</span>
            </div>
          ) : (
